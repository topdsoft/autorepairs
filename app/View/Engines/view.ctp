...
<h2><?php  echo __('Engine');?></h2>
	<dl>
		...
		<dd>
			<?php echo $this->Html->link($engine['Make']['name'], array('controller' => 'makes', 'action' => 'view', $engine['Make']['id'])); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($engine['Vehicle'] as $vehicle): ?>
		<tr>
